...
var ce;
function Pt() {
  return ce === void 0 && (typeof matchMedia == "function" ? ce = !!matchMedia("(pointer:coarse)").matches : ce = false), ce;
}
function Ye(e) {
  ...
  let r = false, a = false, c = -1, f = -1, g = 0, d, z = [];
  {
    let b = -1;
    for (const u of s)
...
function H(e, t) {
  const n = de(e), o = j(n.id, true), i = n.separators.find(
    (g) => g.element === e
  );
...
function Oe(e) {
  ...
  if (!n.disabled)
    switch (e.key) {
      ...
      case "Enter": {
        e.preventDefault();
        const o = de(t), i = j(o.id, true), { derivedPanelConstraints: s, layout: l, separatorToPanels: r } = i, a = o.separators.find(
          (d) => d.element === t
        );
...
function Ut({
  ...
  }), m = Pe(r), S = (0, import_react.useRef)(null), [v, y] = Bt(), h = (0, import_react.useRef)({
  ...
  return K(() => {
    ...
    F.current = R;
    const k = Vt(R), { defaultLayoutDeferred: I, derivedPanelConstraints: $, layout: ae } = j(R.id, true);
...
function on({
  ...
  const i = t !== void 0, s = "id" in o ? o.id : o.groupId, l = pe(s, t ?? []), r = (0, import_react.useSyncExternalStore)(
    Xt,
    () => n.getItem(l),
    () => n.getItem(l)
...
function qt(e, t) {
  const { id: n } = Re(), o = (0, import_react.useRef)({
    collapse: ge,
    expand: ge,
    getSize: () => ({
      asPercentage: 0,
...
function Yt({
  ...
  const u = !!a, p = Pe(a), m = Ce({
    disabled: s
  }), S = (0, import_react.useRef)(null), v = Le(S, l), {
    getPanelStyles: y,
    id: h,
    orientation: P,
    registerPanel: M,
...
function Qt({
  ...
  const a = Pe(s), c = Ce({
    disabled: n,
    disableDoubleClick: o
  }), [f, g] = (0, import_react.useState)({}), [d, z] = (0, import_react.useState)("inactive"), b = (0, import_react.useRef)(null), u = Le(b, i), {
    disableCursor: p,
    id: m,
    orientation: S,
    registerSeparator: v,
  ...
  }, [m, a, v, c]), (0, import_react.useEffect)(() => {
    y(a, { disabled: n, disableDoubleClick: o });
  }, [n, o, a, y]);
  let P;
  return n && !p && (P = "not-allowed"), (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...r,
