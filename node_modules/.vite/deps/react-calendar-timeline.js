import {
  init_moment,
  moment_exports
} from "./chunk-NSLN2KNF.js";
import {
  require_react
} from "./chunk-KZEWNMNK.js";
import {
  __commonJS,
  __esm,
  __export,
          ...
          return markers.map(function(marker) {
            switch (marker.type) {
              case _markerType.TimelineMarkerType.Today:
                if (!((/* @__PURE__ */ new Date()).valueOf() >= timelineState.canvasTimeStart && (/* @__PURE__ */ new Date()).valueOf() <= timelineState.canvasTimeEnd)) return null;
    ...
    var TimelineHeaders = (function(_React$Component) {
      ...
      function TimelineHeaders2(props) {
        ...
        _defineProperty(_assertThisInitialized(_this), "isSidebarHeader", function(child) {
          if (child.type === void 0) return false;
